...
const AsyncTaskTracker = ({ startEndpoint, startParams, startBody, progressEndpoint, pollInterval, progressDisplayMode = true, onComplete, onError, children }: AsyncTaskTrackerProps) => {
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          >
            <option value="embedder">Embedder Task (Progress Bar)</option>
            <option value="completeness">Completeness Metric (Progress Bar)</option>
            <option value="duplicates">Duplicates Metric (Spinner)</option>
          </select>
        </div>
